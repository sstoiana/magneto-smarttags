...
class Magneto_SmartTags_Block_Catalog_Product_Edit_Tab_Tag extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	public function getSelectedTags() {
		...
		foreach($collection as $tag) {
			$return[$tag->getId()] = array('position' => 0);
		}
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($column->getId() == 'in_products') {
            ...
            if ($column->getFilter()->getValue()) {
                $this->getCollection()->addFieldToFilter('tag_id', array('in' => $productIds));
            } else {
                if($productIds) {
                    $this->getCollection()->addFieldToFilter('tag_id', array('nin' => $productIds));
                }
            }
        } else {
    ...
    public function getGridUrl()
    {
    	return $this->getData('grid_url')
            ...
            : $this->getUrl('*/catalog_product/tagGrid', array(
            '_current'      => true,
